...
/// Распарсить JSON-представление `boards` ISS в доменные типы.
...
/// Распарсить JSON `boards` из `securities/{secid}` в доменные типы.
...
/// Распарсить JSON-представление `securities` ISS в доменные типы.
...
/// Распарсить JSON `securities+marketdata` в снимки инструментов.
...
/// Распарсить JSON-представление `orderbook` ISS в доменные типы.
...
/// Распарсить JSON-представление `candleborders` ISS в доменные типы.
...
/// Распарсить JSON-представление `candles` ISS в доменные типы.
...
/// Распарсить JSON-представление `trades` ISS в доменные типы.
...
/// Распарсить JSON-представление `analytics` ISS в доменные типы.
...
/// Распарсить JSON-представление `turnovers` ISS в доменные типы.
...
/// Распарсить JSON-представление `secstats` ISS в доменные типы.
...
#[cfg(feature = "history")]
/// Распарсить JSON-представление `history/.../dates` ISS в доменные типы.
...
#[cfg(feature = "history")]
/// Распарсить JSON-представление `history` ISS в доменные типы.
...
#[cfg(feature = "news")]
/// Распарсить JSON-представление `sitenews` ISS в доменные типы.
...
#[cfg(feature = "news")]
/// Распарсить JSON-представление `events` ISS в доменные типы.
...
/// Если из payload-а нужен только один блок — это самый прямой API.
...
/// Подготовить top-level блоки payload-а для декодирования нескольких таблиц.
///
